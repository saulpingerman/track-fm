...
| [2026-07-autoregressive-generation.md](2026-07-autoregressive-generation.md) | **active** — rollout pilot queued (eval-only), belief-state gated on it | Closing the generation loop on a density-output model: sample-and-roll ensembles (no training) vs belief-state feedback (Fourier-coeff tokens, self-generated curriculum) |
| [2026-07-world-scale-foundationness.md](2026-07-world-scale-foundationness.md) | **someday** — user-flagged, test way later | Are conditioning channels anti-foundational? Physics-vs-behavioral taxonomy (to test, not assume), traffic-at-finetune alternative, encoder capacity for fine-tune fusion, D5 spatial holdout as expansion gate |
