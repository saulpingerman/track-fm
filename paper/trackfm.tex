...
(Section~\ref{sec:transfer}). Learning-rate transfer follows the same
budget caveat: a proxy-budget sweep across widths placed the optimum at
$10^{-3}$, yet at the full 50M-sample budget it degrades two-hour
containment by 45\% (84 vs.\ 58) --- width-matched LR transfer does not
imply budget-matched transfer, and our recipe keeps $3\times10^{-4}$.
